...
function Login() {
  const [weaveActive, setWeaveActive] = useState(false)
        ...
        <section className="w-full max-w-md sm:max-w-[420px] animate-fade-up">
            ...
            <div className="mb-6 text-center">
              ...
              <p className="mt-1.5 text-sm text-slate-400">
                Sign in to continue with VoxCode AI
              </p>
            </div>

            <LoginForm onInteraction={setWeaveActive} />
          </div>
        </section>
      </div>

      <div className="pointer-events-none fixed inset-x-0 bottom-0 z-20 flex items-center justify-center pb-5 lg:hidden">
        <div className="w-40 opacity-60 sm:w-48 md:w-56">
          <AIWeave />
        </div>
      </div>
    </div>
